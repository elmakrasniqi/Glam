...
<body>
        <nav>
            ...
            <ul class="list">
                ...
                <li><a class="active" href="MakeUp.html">Make up</a></li>
 ...
 <section id="products">
    <div class="product-list" data-name="Jean Paul Gaultier">
        <div class="product-item">
            <img src="image/JEAN PAUL GAULTIER SO SCANDAL EDP.png" alt="JEAN PAUL GAULTIER SO SCANDAL EDP">
            <h3>Jean Paul Gaultier So Scandal EDP</h3>
            <p class="price">79.80€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Note">
            <img src="image/Spf.png" alt="Note Spf 50+">
            <h3>Note Spf </h3>
            <p class="price">11.99€</p>
            <button>Add to cart</button>
        </div>  
        <div class="product-item"data-name="Jean Paul Gaultier">
            <img src="image/JEAN PAUL GAULTIER SCANDAL EDP.png" alt="JEAN PAUL GAULTIER SCANDAL EDP">
            <h3>Jean Paul Gaultier Scandal EDP</h3>
            <p class="price">89.80€</p>
            <button>Add to cart</button>
        </div> 
        <div class="product-item" data-name="Note">
            <img src="image/BB-Cream.png" alt="Note BB-Cream">
            <h3>Note BB-Cream</h3>
            <p class="price">13.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Jean Paul Gaultier">
            <img src="image/JEAN PAUL GAULTIER GAULTIER DIVINE.png" alt="JEAN PAUL GAULTIER GAULTIER DIVINE">
            <h3>Jean Paul Gaultier DIVINE</h3>
            <p class="price">96.78€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Burberry">
            <img src="image/Burberry Her Intense EDP set.png" alt="Burbery Her Intense EDP set">
            <h3>Burberry Her Intense EDP set</h3>
            <p class="price">80.89€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Essence">
            <img src="image/ESSENCE MATT FIXING COMPACT POWDER.png" alt="Essence Mat Fixing Compact Powder">
            <h3> Essence Mat Fixing Compact Powder</h3>
            <p class="price">3.80€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Loreal">
            <img src="image/loreal compact powder.png" alt="Loreal Compact Powder">
        ...
        <div class="product-item" data-name="Note">
            <img src="image/BrowPomade.png" alt="Brow Pomade">
            <h3>Brow Pomade</h3>
            <p class="price">13.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Jean Paul Gaultier">
            <img src="image/JEAN PAUL GAULTIER LE BEAU EDT.png" alt="JEAN PAUL GAULTIER LE BEAU EDT">
            <h3>Jean Paul Gaultier LE BEAU</h3>
            <p class="price">69.80€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Burberry">
            <img src="image/Burberry Ladies My Blush.png" alt="Burbery Ladies My Blush">
            <h3>Burberry Ladies My Blush</h3>
            <p class="price">76.89€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Note">
            <img src="image/Compactpowder.png" alt="Compact Powder">
            <h3>Note Compact Powder</h3>
            <p class="price">8.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Loreal">
            <img src="image/Loreal hydration serum.png" alt="Loreal Hydration Serum">
            <h3>Loreal Hydration Serum</h3>
            <p class="price">13.43€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Note">
            <img src="image/Makeup.png" alt="Lip Corrector">
            <h3> Note Lip Corrector</h3>
            <p class="price">13.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Note">
            <img src="image/Fondation.png" alt="Note Fondation">
            <h3>Note Fondation</h3>
            <p class="price">15.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Burberry">
            <img src="image/Burrberry Hero EDT.png" alt="Burrberry Hero EDT">
            <h3>Burberry Hero EDT</h3>
            <p class="price">76.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Maybelline">
            <img src="image/Maybelline mascara.png" alt="Maybelline Mascara">
            <h3>Maybelline Mascara</h3>
            <p class="price">9.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Essence">
            <img src="image/ESSENCE LASH PRINCESS SCULPTED MASCARA.png" alt="Essence Lash Princess Masscara">
            <h3> Essence Lash Princess Masscara</h3>
            <p class="price">3.80€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Burberry">
            <img src="image/My Burberry.png" alt="My Burberry">
            <h3> My Burberry</h3>
            <p class="price">67.94€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Maybelline">
            <img src="image/Maybellineantiageeraser.png" alt="Maybelline anti-age eraser">
            <h3>Maybelline Anti-age Eraser</h3>
            <p class="price">9.00€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Loreal">
            <img src="image/Loreal shampoo.png" alt="Loreal shampoo">
            <h3> Loreal Shampoo</h3>
            <p class="price">4.80€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Essence">
            <img src="image/ESSENCE INSTANT MATT MAKEUP SPRAY.png" alt="Essence Instant Matt Makeup Spray">
        ...
        <div class="product-item" data-name="Essence">
            <img src="image/ESSENCE EXTREME SHINE VOLUME LIPGLOSS 01.png" alt="Essence Extreme Shine Volume Lipgloss">
        ...
        <div class="product-item" data-name="Jean Paul Gaultier">
            <img src="image/JEAN PAUL GAULTIER LE MALE TERRIBLE EDT.png" alt="JEAN PAUL GAULTIER LE MALE TERRIBLE EDT">
        ...
        <div class="product-item" data-name="Loreal">
            <img src="image/loreal black eyeliner.png" alt="loreal black eyeliner">
            <h3> Loreal Black Eyeliner</h3>
            <p class="price">7.80€</p>
            <button>Add to cart</button>
        </div>
        <div class="product-item" data-name="Jean Paul Gaultier">
            <img src="image/JEAN PAUL GAULTIER ESSENCE EDP.png" alt="JEAN PAUL GAULTIER ESSENCE EDP">
